...
$total_gangguan = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM monitoring WHERE status_koneksi LIKE '%offline%'"));
...
<head>
    ...
    <style>
        ...
        /* ANTI AUTO-ZOOM iOS — font-size minimal 16px di semua input */
