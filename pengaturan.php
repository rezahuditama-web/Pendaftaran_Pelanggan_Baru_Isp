...
<div class="container">
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><i class="fa-solid fa-gear"></i><a href="setting_user.php">Pengaturan</a></li>
        </ul>
        <div class="logout">
        ...
        <div class="table-container" style="padding: 28px;">
            ...
            <div class="tab-content active" id="tab-account">
                ...
                <div class="info-box">
                    ...
                    <span>Halaman ini digunakan untuk <strong>mengelola data admin sistem</strong>.
                    Pastikan informasi yang diisi sudah benar sebelum menyimpan perubahan.</span>
                </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="<?= htmlspecialchars($data_admin['nama_admin'] ?? ''); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-prefix">
                                ...
                                <input
                                    ...
                                    value="<?= htmlspecialchars($data_admin['no_telepon'] ?? ''); ?>"
                                    required
                                />
                            </div>
                        </div>
            ...
            <!-- ================================
                 TAB 2: LOGIN & KEAMANAN
            ================================= -->
            <div class="tab-content" id="tab-security">
                <form method="POST">
                    <h4 style="font-size: 15px; font-weight: 600; color: #333; margin-bottom: 20px;">
                        <i class="fa-solid fa-lock" style="color: #1a73e8;"></i> Ganti Password
                    </h4>
                    ...
                    <button type="submit" name="ganti_password" class="btn-update">
...
<script>
    ...
    function updatePreview(val) {
        ...
        const initials = words.length >= 2
            ...
            : (val.substring(0, 2) || 'AD').toUpperCase();
